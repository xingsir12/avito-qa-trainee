...
| Проект                | Avito.ru                                                                                                                                                                                                            |
| Локация               | Блок выдачи объявлений                                                                                                                                                                                              |
| Описание              | При выбранном регионе «Москва» (поле «Москва, район, метро») в выдаче отображаются объявления с локациями других городов (Новосибирск и др.).<br/> Фильтр по геолокации не применяется или применяется некорректно. |
| Приоритет (Priority)  | P1                                                                                                                                                                                                                  |
| Ожидаемый результат   | В выдаче отображаются только объявления, соответствующие выбранному региону (Москва).                                                                                                                               |
| Фактический результат | В выдаче присутствуют объявления из других городов (например, Новосибирск), что нарушает релевантность поиска.                                                                                                      |
...
| Проект                | Avito.ru                                                                                                                                             |
| Локация               | Карточка товара                                                                                                                                      |
| Описание              | Карточка объявления отображается с небольшим наклоном вправо, в то время как остальные карточки в выдаче имеют ровное (горизонтальное) расположение. |
| Приоритет (Priority)  | P3                                                                                                                                                   |
...
|:----------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Проект                | Avito.ru                                                                                                                                                                                                                         |
| Локация               | Боковая панель, заголовок страница, кнопка фильтров                                                                                                                                                                              |
...
<img src="img/bug_13.png" width="" height="">
